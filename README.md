...
Ferramenta para ajudar na revisão de artigos e trabalhos acadêmicos, organizando problemas identificados, separando regras normativas de sugestões assistidas e apoiando o fluxo de correção do autor.
...
- **Sprint 4 executada em código**: fluxo rascunho → revisão → versão final com snapshots, comparação lado a lado por parágrafo e feedback “isso ajudou?”; 41 testes.
- Como rodar: `bun install` · `bun run dev` · `bun test` · `bun run build`.
- A última sprint é a Sprint 5 — Polimento, Qualidade e Entrega (DC-12 e DC-14 em `docs/03-decisoes-tecnologias.md`).
